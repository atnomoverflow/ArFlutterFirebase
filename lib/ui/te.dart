...
import 'package:obj_detect/utils/isolate_utils.dart';
...
class _CameraViewState extends State<CameraView> with WidgetsBindingObserver {
  ...
  void initializeCamera() async {
    ...
    cameraController?.initialize().then((_) async {
      ...
      CameraViewSingleton.ratio =
          (cameraController!.value.aspectRatio * screenSize.width) /
              (cameraController!.value.aspectRatio * previewSize.height);
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    CameraViewSingleton.ratio = scale;
